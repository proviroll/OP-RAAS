...
# original path : https://github.com/ethereum-optimism/optimism/blob/tutorials/chain/packages/contracts-bedrock/scripts/getting-started/config.sh
...
$altDaConfig
  ...
  "requiredProtocolVersion": "<REDACTED_PRIVATE_KEY>",
  "recommendedProtocolVersion": "<REDACTED_PRIVATE_KEY>",
  "fundDevAccounts": false,
  "faultGameAbsolutePrestate": "<REDACTED_PRIVATE_KEY>",
  "faultGameMaxDepth": 73,
  "faultGameClockExtension": 10800,
  "faultGameMaxClockDuration": 302400,
  "faultGameGenesisBlock": 0,
  "faultGameGenesisOutputRoot": "<REDACTED_PRIVATE_KEY>",
